...
namespace PuReEngine
{
    namespace Graphics
    {
        namespace DirectX10
        {
            ...
            /// @brief Rendertarget within DirectX10
            ///
            ...
            private:
                ...
                /// @brief Pointer to the DephtSTencilState
                ///
                ID3D10DepthStencilState* m_pLightDepthStencilState;
                /// @brief Blend State for Lighting
                ///
                ID3D10BlendState* m_pLightBlendState;
            ...
            public:
                ...
                /// @param QuadBuffer
                ///
                CRendertarget(IGraphics* a_pGraphics, ID3D10Device* a_pDevice, const STexture2DDescription& a_rDescription, Quad* a_pQuadBuffer);
