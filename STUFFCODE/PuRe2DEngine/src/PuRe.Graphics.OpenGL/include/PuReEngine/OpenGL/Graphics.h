...
#include "PuReEngine/WindowDescription.h"
#include "PuReEngine/BoundingBox.h"

// PuReEngine::OpenGL specific includes
#include "Material.h"
#include "Texture2D.h"
...
namespace PuReEngine
{
    namespace Graphics
    {
        namespace OpenGL
        {
            ...
            using ::PuReEngine::Core::SWindowDescription;
            using ::PuReEngine::Core::CBoundingBox;

            /// @brief Graphic Class for OpenGL
            ///
            ...
            private:
                ...
                /// @brief Pointer to the Graphic-Platform Interface
                ///
                COSGraphics* m_pGraphicPlatform;
                ...
                /// @brief Our Texture
                ///
                CTexture2D* m_BackBufferTexture;
                /// @brief Our Texture
                ///
                CTexture2D* m_DepthBufferTexture;
            public:
            ...
            public:
                ...
                /// @brief Returns the BackBuffer Texture
                ///
                /// @returns Pointer to the BackBuffer
                ///
                ITexture2D* GetBackBuffer();
                ...
                ///
                void DrawInstanced(PuReEngine::Core::EPrimitive a_Primitive, int32 a_Vertices, int32 a_Instances);
            ...
            extern "C"
            {
                ...
                ///
                PuReEngine::Core::IGraphics* CreateGraphics(IWindow* window, IPlatform* platform, SGraphicsDescription& description)
                {
                    return new PuReEngine::Graphics::OpenGL::CGraphics(window, platform, description);
                }
            }
        }
    }
