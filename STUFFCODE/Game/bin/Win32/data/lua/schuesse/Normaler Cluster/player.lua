...
function Shoot(c0,c1,c2,c3,c4,c5,PlayerNum,X,Y,Angle,Speed)
	...
	Cooldown = 20; -- Wie Lange bis zum nächsten Schuss. In 1/60 Sekunden gemessen
	...
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(22,5));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(45));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(67,5));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(90));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(122,5));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(140));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(162,5));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(180));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(-22,5));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(-45));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(-67,5));
	CreateBullet(PlayerNum, 1, X, Y, 10, math.rad(-90));
