...
function Shoot(c0,c1,c2,c3,c4,c5,PlayerNum,X,Y,Angle,Speed)
	...
	Cooldown = 40; -- Wie Lange bis zum nächsten Schuss. In 1/60 Sekunden gemessen
	...
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(0));	-- Spawned einen Schuss mit Angegbene Werten. Dieser Code kann auch mehrmals aufgerufen Werden
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(22,5));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(45));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(67,5));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(90));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(122,5));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(140));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(162,5));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(180));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(-22,5));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(-45));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(-67,5));
	CreateBullet(PlayerNum, 1, X + 200, Y + 200, 10, math.rad(-90));
	...
	CreateBullet(PlayerNum, 1, X - 200, Y - 200, 10, math.rad(0));
	CreateBullet(PlayerNum, 1, X - 200, Y - 200, 10, math.rad(22,5));
	CreateBullet(PlayerNum, 1, X - 200, Y - 200, 10, math.rad(45));
	CreateBullet(PlayerNum, 1, X - 200, Y - 200, 10, math.rad(67,5));
	CreateBullet(PlayerNum, 1, X - 200, Y - 200, 10, math.rad(90));
